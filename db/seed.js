...
const seedUsers = () => db.Promise.map([
  {first_name: "Bill", last_name:"Murray", email: "bill@billmurray.com", about:"I'm Bill and I love company on long drives.", picture: "Bill.png"},
  {first_name: "Ben", last_name:"Folds", email: "ben@folds.com", about:"My hobbies include driving", picture: "Bill.png"},
  ...
  {first_name: "Peter", last_name:"Venkman", email: "peter@gmail.com", about:"Peter Venkman Ph.D. of parapsychology. Likes dogs,cats and good conversation. Dislikes ghosts, getting slimed, and driving alone. When I’m not chasing ghosts I like chasing long luxurious drives down the 401.", password: "$2a$10$B1t70OrcmkNqFViSLAeNc.sdEmtXmMqFSKA/3fvEiswKQSBdPXtYu", drivers_license: "111",  picture: "Raymond.png"},
  {first_name: "Janine", last_name:"Melnitz", email: "janine@gmail.com", about:"My job is pretty boring so I like to travel whenever I can. My ideal passenger is quiet, polite and doesn’t talk about science or the supernatural. I get enough of that form the “scientists” I work with.", drivers_license: "111",  picture: "Janine.png"}
